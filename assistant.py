...
wake_word = 'Ringo'
groq_client = Groq(api_key = "your_api_key") # REPLACE WITH YOUR GROQ API KEY
genai.configure(api_key='your_api_key')  # REPLACE WITH YOUR GOOGLE GENERATIVE AI API KEY
openai_client = OpenAI(api_key='your_api_key')  # REPLACE WITH YOUR OPENAI API KEY
...
def speak(text) :
    ...
    with openai_client.audio.speech.with_streaming_response.create(
        model='tts-1',
        voice='echo',#there are many voices to choose from, this is just an example
        response_format='pcm',
        input=text,
    ) as response:
